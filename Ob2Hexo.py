...
class Ob2Hexo:
    def __init__(self, file_name: str = None) -> None:
        ...
        try:
            ...
            with open("Obsidian2Hexo/setting.json", encoding="utf-8") as f:
                setting = json.load(f)
                ...
                self.hexo_file_path = (
                    os.path.join(self.hexo_path, self.file_name + ".md")
                    if file_name
                    else None
                )
    ...
    def get_photo(self, file_path):
        ...
        for photo in pattern.findall(content):
            ...
            shutil.copyfile(
                os.path.join(self.photo_path, r_photo_name),
                os.path.join(self.hexo_photo_path, r_photo_name),
            )
        ...
        for i in pattern_wiki.findall(content):
            ...
            shutil.copyfile(
                os.path.join(self.photo_path, r_i_name),
                os.path.join(self.hexo_photo_path, r_i_name),
            )
